...
(function (root, factory) {
    ...
    function getStyle(elm, style) {
        ...
        return elm.currentStyle.getAttribute(
            style.replace(/-(\w)/g, function (v, v1) {
    ...
    MultiClamp.prototype = {
        ...
        preInit: function (option) {
            this.option = {
                ...
                onClampStart: "onClampStart" in option && typeof option.onClampStart === "function" ? option.onClampStart : function () {},
                onClampEnd: "onClampEnd" in option && typeof option.onClampEnd === "function" ? option.onClampEnd : function () {},
            };
        ...
        clamp: function () {
            ...
            function doNotNeedToClamp(isForcePrevent) {
                if (!isForcePrevent)
                    self.option.onClampStart.call(self, {
                        needClamp: false,
                    });
